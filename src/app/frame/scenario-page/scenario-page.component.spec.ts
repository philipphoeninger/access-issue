...
describe('ScenarioPageComponent (docs/SPEC_v1.md Slice 3)', () => {
  ...
  describe('the step view (src/app/scenarios/scenario-step-views.ts)', () => {
    ...
    // Steps 2 to 4 have no view yet (slices 8 to 10). That is a defined state,
    // not an error: the region renders empty and the bar falls back to the
    // bare domain rather than to a path the frame invented.
