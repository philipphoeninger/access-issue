...
| ~~`Elbwerk` checked against the trade register and DPMA~~ — done: an `Elbwerk GmbH` exists, `Elbwerk AG` does not. The company is now an AG (`DESIGN.md` §2.1) | Philipp — closed |
