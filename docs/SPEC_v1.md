...
| ~~`Elbwerk` checked against the trade register and DPMA~~ — done: an `Elbwerk GmbH` exists. The company is now `Elbwerk GmbH & Co. KG`, which does not (`DESIGN.md` §2.1) | Philipp — closed |
